...
export function AppLayout() {
  ...
  return (
    <TooltipProvider delayDuration={300} skipDelayDuration={100}>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[200] focus:px-4 focus:py-2 focus:bg-background focus:border focus:rounded-lg focus:text-sm focus:font-medium">
